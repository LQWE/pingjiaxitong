...
class IndexController extends Controller
{
    public function _initialize()
    {
 	...
 	public function search($page = 1, $type_id =0 ,$keyword="",$province=0,$city=0,$district=0)
 		{
    ...
    public function edit($id)
    {
        ...
        $event_content['user'] = query_user(array('id', 'username', 'nickname', 'space_url', 'space_link', 'avatar64', 'rank_html', 'signature'), $event_content['uid']);
		$event_content['province']=floor($event_content['district']/10000)*10000;
		$event_content['city']=floor($event_content['district']/100)*100;
        $this->assign('content', $event_content);
